...
.box-it li, .box-it, .creditos, .box-sz1 h2, .box-sz2 h2 {font-family: 'TIMSansWeb', Fallback, times-new-roman}
.box-it li {color:#fff;padding-top:15px}
.box-sz1 h2, .box-sz2 h2 {color:#89c3ff;font-size:11pt}
  
@media only screen and (min-width: 360px) {

#footer-tim {width:100%;background-color: #004691;margin-top:200px;height:525px;color:#89c3ff}
.home-first-section {margin-top:0px}
.box-sz2 p {margin-top:5px}
.container-2 {width:360px}
.box-it {float:none;padding:20px}
.box-sz1 {width:320px}
.nav-f {display:block;width:340px;z-index:9999;position:relative}
...
.box-sz2 {width:320px;text-align:center}
.footer-tim {width:340px;margin:0 auto;height:300px;font-size:10pt;padding:10px;background-color: #004691}
.creditos {width:340px;height:50px;text-align:center;color:#89c3ff;font-size:9pt;clear:both;margin-top:170px}
.box-sz2 h2 {padding-top:10px}
...
.tfc img {width:71px}
.tfc {width:100px;float:left;margin-top:7px}
...
.nav-f {width:420px;float:left;padding-left:70px;display:block}
.creditos {margin-top:190px;width:750px}
#footer-tim {margin-top:40px}

}

@media only screen and (min-width: 960px) {
#footer-tim {width:100%;background-color: #004691;height:300px;color:#89c3ff;margin-top:25px}
.box-it {float:left;padding:20px}
.box-sz1 {width:150px}
.box-sz2 {width:310px;text-align:center}
.box-sz3 {width:700px}
...
.tfc {width:120px;float:left;padding-left:20px;padding-top:29px;margin-top:0}


.footer-tim {width:1000px;margin:0 auto;height:170px;font-size:10pt;padding:30px}
...
/*
#mega-menu-wrap-footer-1 #mega-menu-footer-1 > li.mega-menu-flyout ul.mega-sub-menu li.mega-menu-item a.mega-menu-link:hover, #mega-menu-wrap-footer-1 #mega-menu-footer-1 > li.mega-menu-flyout ul.mega-sub-menu li.mega-menu-item a.mega-menu-link:focus {
...
.rede-social {width:200px;float:right;display:block}
.rede-social li {display:inline-block;padding:5px}
.rede-social li a {color:#fff}
.nav-i {width:550px;height:30px}
.nav-e {width:350px;float:left;padding-bottom:0;padding-top:0}
